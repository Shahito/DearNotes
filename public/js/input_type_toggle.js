const lock = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const lock_open = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function toggle(id){
    const trigger = document.getElementById("toggle-"+id);
    const input = document.getElementById(id);
    trigger.innerHTML = lock;
    input.classList.add('view-lock');
